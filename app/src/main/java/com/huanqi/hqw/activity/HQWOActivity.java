...
public class HQWOActivity extends Activity {
    ...
    public com.huanqi.hqw.Interface.permission permission;
    public com.huanqi.hqw.Interface.orientation orientation;
    ...
    public void setToast(String text) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                toast = Toast.makeText(HQWOActivity.this, text, Toast.LENGTH_SHORT);
                toast.show();
            }
        });
    }
