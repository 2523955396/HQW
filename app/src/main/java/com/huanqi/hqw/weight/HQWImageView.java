...
/*
/*可放大缩小的imageview by焕奇灵动
 */
 public class HQWImageView extends AppCompatImageView implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public HQWImageView(Context context) {
        this(context, null);
    }

    public HQWImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HQWImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                if(onClickListener != null)
                    onClickListener.onClick(HQWImageView.this);
                return true;
            }
        });
